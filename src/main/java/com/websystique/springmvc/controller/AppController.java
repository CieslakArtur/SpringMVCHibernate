...
public class AppController {
	...
	public String saveEmployee(@Valid Employee employee, BindingResult result, ModelMap model) {
		...
		/*
		 * Preffered way to achieve uniqueness of field [ssn] should be implementing
		 * custom @Unique annotation and applying it to field [ssn] of Model class
		 * [Employee]
		 * 
		 * Below mentioned peace of code [if block] is to demenstrate that you can fill
	...
	/*
	 * This method will delete an employee it's SSN value
	 */
	@RequestMapping(value= {"/edit-{ssn}-employee"},method=RequestMethod.GET)
